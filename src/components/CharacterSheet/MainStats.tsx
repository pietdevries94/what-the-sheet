...
const StatBlock: React.FC<{ label: string; value: number | null }> = ({
	...
	return (
		<div className="flex flex-col items-center justify-center relative py-2">
			<span className="text-sm tracking-wide text-stone-500 absolute top-0 border-stone-400 bg-background leading-none py-0.5 h-5 text-center w-9 rounded-md border">
				{label}
			</span>
			...
			<span className="text-sm text-stone-500 absolute bottom-0 bg-background border-stone-400 leading-none py-0.5 h-5 w-6 text-center rounded-md border">
				{value}
			</span>
		</div>
	);
